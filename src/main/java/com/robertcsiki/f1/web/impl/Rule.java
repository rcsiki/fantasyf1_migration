...
import com.robertcsiki.f1.web.util.ArithmeticExpressionEvaluator;
...
public class Rule extends ObjectBase implements IRule
{
	   ...
	   throws Exception
	{
        ...
        String strDriverId1 = team.getDriverId1(strRaceId);
        ...
        String strDriverId2 = team.getDriverId2(strRaceId);
