...
public class Player extends ObjectBase implements IPlayer
{
	...
	/* (non-Javadoc)
	 * @see com.homelinux.bela.web.fc.IPlayer#setDriverId1(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.homelinux.bela.web.fc.IPlayer#setDriverId2(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.homelinux.bela.web.fc.IPlayer#setTeamId1(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.homelinux.bela.web.fc.IPlayer#setTeamId2(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.homelinux.bela.web.fc.IPlayer#printPlayerDetails(java.io.OutputStream)
	 */
	...
	/* (non-Javadoc)
	 * @see com.homelinux.bela.web.fc.IPlayer#printPlayerStandings(java.io.OutputStream)
	 */
	...
	/* (non-Javadoc)
	 * @see com.homelinux.bela.web.fc.IPlayer#printPlayerRaceDetails(java.lang.String, java.io.OutputStream)
	 */
	   ...
	   throws Exception
	{
		...
		if (wasDriver1Replaced == true || wasDriver2Replaced == true)
		{
			...
			if (wasDriver1Replaced == true)
			{				pc = cm.getDriverById(this.getDriverId1());	
				...
				sb.append(" on team ");	
				sb.append(cm.getTeamById( ((IDriver)pc).getTeamId()).getName());	
				sb.append(".</td></tr>");	
			}
