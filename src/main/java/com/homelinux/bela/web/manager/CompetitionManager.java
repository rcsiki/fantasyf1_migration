...
//			sb.append("</TR>");
                                               ...
                                               String strTieBreakerAnswer )
    {
    	...
    	else
    	{
			...
			{
				result.append(" class=\"tablelayout\">Congratulations! Your 2008 Fantasy Formula1 Team configuration is:");
				...
				result.append(" valued at $20 CDN by <b>April 22th, 2008</b>, to the following mail address:<p>");
				result.append("<b>Laszlo Benedek, 16 Marchwood Cres. Richmond Hill, ON, L4C 8M7, Canada</b><p>");
				...
				result.append("<br><p><b>Thank You and have a strong 2008 Fantasy Formula 1 Season!</b>");
			}    		
    	}
