<%@ page errorPage="error.jsp" import="java.lang.System,com.homelinux.bela.web.manager.CompetitionManager,com.homelinux.bela.web.config.WebConfig,com.homelinux.bela.web.util.FormUtil"%>
<HTML>
<HEAD>
