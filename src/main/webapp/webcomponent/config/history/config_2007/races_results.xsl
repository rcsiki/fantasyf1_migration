  ...
  <xsl:template match="text()"></xsl:template>
    <xsl:template match="table[starts-with(normalize-space(tr[1]/td[2]),'&#160;')]">
      ...
      <driver>
        ...
        <id>
          <xsl:value-of select="normalize-space(tr[4]/td[1]/table[1]/tr[43]/td[5])"/>
        </id>
        <laps>
          <xsl:value-of select="normalize-space(tr[4]/td[1]/table[1]/tr[43]/td[8])"/>
        </laps>
        <grid>
          <xsl:value-of select="normalize-space(tr[4]/td[1]/table[1]/tr[43]/td[11])"/>
        </grid>
      </driver>
      <driver>
        <pos>
          <xsl:value-of select="normalize-space(tr[4]/td[1]/table[1]/tr[45]/td[1])"/>
        </pos>
        <id>
          <xsl:value-of select="normalize-space(tr[4]/td[1]/table[1]/tr[45]/td[5])"/>
        </id>
        <laps>
          <xsl:value-of select="normalize-space(tr[4]/td[1]/table[1]/tr[45]/td[8])"/>
        </laps>
        <grid>
          <xsl:value-of select="normalize-space(tr[4]/td[1]/table[1]/tr[45]/td[11])"/>
        </grid>
      </driver>
      <fastestlap>
			  Fastest Lap: Fernando Alonso 1:22:33
<!--
